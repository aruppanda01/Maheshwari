        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
               ...
               Add Contact Us
                ...
                <hr>
                <form action="{{ route('admin.contact.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                    ...
                    <div class="tile-body">
                     ...
                     <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('mobile_no') is-invalid @enderror" type="text" name="mobile_no" id="mobile_no" value="{{ old('mobile_no') }}"/>
