        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
               ...
               Edit FAQ
                ...
                <hr>
                <form action="{{ route('admin.faq.update',$faq->id) }}" method="POST" role="form">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="question">Question<span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('question') is-invalid @enderror" type="text" name="question" id="question" value="{{ $faq->question }}"/>
