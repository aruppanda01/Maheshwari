...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-tags"></i> Photo</h1>
        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
               ...
               Add Photo
                ...
                <hr>
                <form action="{{ route('admin.photo.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="category">Category Name<span class="m-l-5 text-danger"> *</span></label>
