        ...
        <div class="col-md-8 mx-auto">
            <div class="tile">
               ...
               Edit Event
                ...
                <hr>
                <form action="{{ route('admin.event.update',$event_details->id) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="title">Title<span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('title') is-invalid @enderror" type="text" name="title" id="title" value="{{ $event_details->title  }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('start_date') is-invalid @enderror" type="date" name="start_date" id="start_date" value="{{ $event_details->start_date }}" min="{{ date('Y-m-d',strtotime('+1 day')) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('end_date') is-invalid @enderror" type="date" name="end_date" id="end_date" value="{{ $event_details->end_date }}" min="{{ date('Y-m-d',strtotime('+1 day')) }}"/>
                    ...
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="3" rows="10" class="form-control @error('description') is-invalid @enderror">
                                {{ $event_details->description }}</textarea>
                    ...
                    <div class="tile-body">
                        ...
                        @if ($event_details->image)
                            <img src="{{ asset($event_details->image) }}" alt="" height="100" width="100">
                        @endif
                    </div>
